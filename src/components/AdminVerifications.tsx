            ...
            <div className="modal-content verification-details-modal large" onClick={(e) => e.stopPropagation()}>
              ...
              {loadingDetails ? (
                ...
                <div className="modal-body">
                  ...
                  {(selectedVerification.userName || selectedVerification.user?.fullName || selectedVerification.userEmail || selectedVerification.user?.email) && (
                          ...
                          <div className="checks-list-modal">
                            ...
                            {selectedVerification.results.checks.nameMatch !== undefined && (
                              <div className={`check-item-modal ${selectedVerification.results.checks.nameMatch ? 'pass' : 'fail'}`}>
                                ...
                                <span>
                                  Name Match
                                  {selectedVerification.results.checks.nameMatchScore !== undefined && (
                                    <span className="face-score">
