...
export const DealerVerification: React.FC = () => {
    ...
    try {
      ...
      if (!currentVerificationId) {
        ...
        const createResponse = await fetch(getApiUrl(url), {
          ...
          body: JSON.stringify({
            type: 'IDENTITY',
            metadata: { source: 'web', flow: 'dealer-verify' }
          })
        });
  ...
  if (isLoading) {
    return (
      <div className="id-verification-container dealer-verification">
    ...
    <div className="id-verification-container dealer-verification">
      ...
      <div className="verification-header">
        ...
        <div className="verification-illustration">
          <img src="/verification-illustration.svg" alt="Dealer Verification" />
        </div>
            ...
            {partnerInfo?.companyName && (
              <div className="welcome-message">
                <p className="request-info">
                  ...
                  <strong>{partnerInfo.companyName}</strong> has requested you to complete a dealer verification.
            ...
            {currentStep.step === 'processing' && (
              <div className="document-processing-screen">
                ...
                <div className="processing-text">
                  ...
                  <p>Please wait while we finalize your dealer verification...</p>
                  <div className="processing-steps">
                    <div className="processing-step active">
                      <span className="step-icon">🔄</span>
